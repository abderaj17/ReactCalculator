...
const Calculator = () => {
  ...
  return (
    <div className='border border-balck w-fit mx-auto mt-[100px] rounded-lg bg-slate-800 p-2'>
        ...
        <div className='grid grid-cols-4 max-w-fit gap-8 p-2'>
            ...
            <button onClick={HandleBackSpace} className='border h-12 w-12 rounded-[50%] bg-white'>👈</button>
            <button onClick={HandleClick} className='border h-12 w-12 rounded-[50%] bg-white'>.</button>
